---
title: "Microarray Data - Bmpr1a KO - DGE Reanalysis with LIMMA"
...
biolrep = ifelse(ed_tmp$Cy5_replicate==3221 | ed_tmp$Cy3_replicate==3221, 1, 2)
design = ifelse(ed_tmp$Cy5=="KO", 1, -1)
...
all_results[["Bmpr1a_KO_vs_WT"]] = res
```
