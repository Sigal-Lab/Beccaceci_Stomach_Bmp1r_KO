---
title: "Microarray Data - Bmpr1a KO - Reanalysis with LIMMA"
...
This is data from mouse experiments (Bmpr1a KO, Giulia Beccaceci) hybridized as dual channel libraries to Agilent 074809 (SurePrint G3 Mouse GE v2 8x60K) micro arrays. 
...
exp_design = subset(exp_design, Scan.ID %in% c("18308","18309","18310","18311"))
...
exp_design$Cy3_label = with(exp_design, paste(Cy3, Cy3_replicate, sep="_"))
exp_design$Cy5_label = with(exp_design, paste(Cy5, Cy5_replicate, sep="_"))
